---
title: "2028_iRonCub_3_The_Jet-Powered_Flying_Humanoid_Robot"
authors:
  - "Davide Gorbani"
...
arxiv: ""
score: 4.0
essence: "iRonCub 3는 제트 터빈 4개를 장착한 완전 인형형 비행 로봇으로, 시뮬레이션 검증 후 최초로 수직 이착륙에 성공했다."
tags:
...
- 🔗 후속 연구: [[papers/2044_Learning_Aerodynamics_for_the_Control_of_Flying_Humanoid_Rob/review]] — iRonCub 3의 제트 추진 비행이 공기역학 학습과 결합되어 더 정교한 비행 제어를 실현할 수 있다.
- 🏛 기반 연구: [[papers/1832_CAD-Driven_Co-Design_for_Flight-Ready_Jet-Powered_Humanoids/review]] — 비행용 제트 추진 휴머노이드의 CAD 기반 공동 설계가 iRonCub 3 개발의 설계 기반을 제공한다.
- 🔗 후속 연구: [[papers/2072_Learning_to_Walk_and_Fly_with_Adversarial_Motion_Priors/review]] — 지상 보행과 공중 비행을 모두 포함하는 다중 모드 휴머노이드 제어를 위한 적대적 모션 우선순위 학습 방법을 확장할 수 있다.
- 🔗 후속 연구: [[papers/1832_CAD-Driven_Co-Design_for_Flight-Ready_Jet-Powered_Humanoids/review]] — iRonCub 3의 실제 제트 추진 비행 로봇 구현 경험이 CAD 기반 설계 최적화의 실용성을 검증하고 개선 방향을 제시한다
- 🏛 기반 연구: [[papers/2016_HUSKY_Humanoid_Skateboarding_System_via_Physics-Aware_Whole-/review]] — HUSKY의 physics-aware whole-body control 프레임워크가 iRonCub 3의 제트 추진 비행 제어 시스템의 기초 이론을 제공한다.
- 🧪 응용 사례: [[papers/2044_Learning_Aerodynamics_for_the_Control_of_Flying_Humanoid_Rob/review]] — 공기역학 학습 방법론이 iRonCub-Mk1의 제트 엔진 비행 제어에 직접 적용된다.
- 🧪 응용 사례: [[papers/2072_Learning_to_Walk_and_Fly_with_Adversarial_Motion_Priors/review]] — 항공 휴머노이드의 보행-비행 전환이 제트 동력 비행 휴머노이드 로봇에 직접 적용된다.
