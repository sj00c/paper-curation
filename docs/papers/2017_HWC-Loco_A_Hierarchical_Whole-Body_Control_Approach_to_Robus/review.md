---
title: "2017_HWC-Loco_A_Hierarchical_Whole-Body_Control_Approach_to_Robus"
authors:
  - "Sixu Lin"
  - "Guanren Qiao"
  - "Yunxin Tai"
...
arxiv: ""
score: 4.0
essence: "HWC-Loco는 휴머노이드 로봇의 견고한 이동을 위해 계층적 정책 구조로 목표 추적과 안전 복구 간의 trade-off를 동적으로 해결하는 강화학습 기반 전신 제어 알고리즘이다."
tags:
...
- 🔄 다른 접근: [[papers/1671_SHIELD_Safety_on_Humanoids_via_CBFs_In_Expectation_on_Learne/review]] — 둘 다 안전한 휴머노이드 제어를 위한 계층적 접근이지만 HWC-Loco는 목표-안전 trade-off, SHIELD는 CBF 기반
- 🔗 후속 연구: [[papers/2033_Keep_on_Going_Learning_Robust_Humanoid_Motion_Skills_via_Sel/review]] — HWC-Loco의 계층적 안전 제어가 Keep on Going의 적대적 강화 방법과 결합되어 더 견고한 로봇 제어 달성 가능
- 🏛 기반 연구: [[papers/1954_Geometry-Aware_Predictive_Safety_Filters_on_Humanoids_From_P/review]] — 기하학적 예측 안전 필터가 HWC-Loco의 계층적 제어 구조에서 안전 복구 정책의 이론적 기반 제공
- 🔗 후속 연구: [[papers/1617_PILOT_A_Perceptive_Integrated_Low-level_Controller_for_Loco-/review]] — HWC-Loco의 계층적 전신 제어 접근법이 PILOT의 통합 저수준 제어 프레임워크를 더욱 체계적으로 확장함
