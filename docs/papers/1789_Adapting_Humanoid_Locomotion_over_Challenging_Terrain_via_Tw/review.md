---
title: "1789_Adapting_Humanoid_Locomotion_over_Challenging_Terrain_via_Tw"
authors:
  - "| **날짜**:"
date: ""
doi: ""
arxiv: ""
score: 4.0
essence: "Transformer 기반 humanoid 제어기를 flat ground에서 sequence modeling으로 사전학습한 후 challenging terrain에서 reinforcement learning으로 fine-tuning하는 두 단계 학습 방법을 제안하여, 시뮬레이션과 실제 로봇에서 다양한 복잡한 지형 보행을 성공적으로 달성했다."
tags:
...
- 🔄 다른 접근: [[papers/1804_APEX_Learning_Adaptive_High-Platform_Traversal_for_Humanoid/review]] — 둘 다 challenging terrain traversal을 다루지만 APEX는 높은 플랫폼 특화, Transformer 논문은 일반적인 복잡 지형에 초점을 맞춥니다.
- 🔄 다른 접근: [[papers/1996_Humanoid_Locomotion_as_Next_Token_Prediction/review]] — terrain 적응을 위해 하나는 transformer sequence modeling, 다른 하나는 next token prediction을 사용합니다.
- 🧪 응용 사례: [[papers/1811_BeamDojo_Learning_Agile_Humanoid_Locomotion_on_Sparse_Footho/review]] — Transformer 기반 사전훈련이 BeamDojo의 sparse foothold에서의 agile locomotion 학습을 가속화합니다.
- 🔄 다른 접근: [[papers/1755_Walk_the_PLANC_Physics-Guided_RL_for_Agile_Humanoid_Locomoti/review]] — 둘 다 challenging terrain 보행을 다루지만 Transformer는 sequence modeling에, PLANC는 physics-guided RL에 중점을 둔다.
- 🔗 후속 연구: [[papers/1791_Advancing_Humanoid_Locomotion_Mastering_Challenging_Terrains/review]] — DWL의 end-to-end 강화학습이 Transformer 기반 두 단계 학습을 단일 프레임워크로 통합할 수 있는 가능성을 제시한다.
- 🧪 응용 사례: [[papers/2162_TTT-Parkour_Rapid_Test-Time_Training_for_Perceptive_Robot_Pa/review]] — test-time training을 통한 실시간 적응이 Transformer 기반 terrain adaptation의 동적 환경 대응 능력을 강화할 수 있다.
- 🔄 다른 접근: [[papers/1755_Walk_the_PLANC_Physics-Guided_RL_for_Agile_Humanoid_Locomoti/review]] — 둘 다 challenging terrain 보행을 다루지만 PLANC는 물리학 기반 구조로, Transformer 접근법은 sequence modeling으로 해결한다.
- 🔄 다른 접근: [[papers/1804_APEX_Learning_Adaptive_High-Platform_Traversal_for_Humanoid/review]] — 둘 다 challenging terrain을 다루지만 Transformer는 일반적 복잡 지형, APEX는 높은 플랫폼 traversal에 특화됩니다.
- 🔄 다른 접근: [[papers/1791_Advancing_Humanoid_Locomotion_Mastering_Challenging_Terrains/review]] — 둘 다 복잡한 지형 보행을 다루지만 DWL은 end-to-end 학습에, Transformer 접근법은 두 단계 학습에 중점을 둔다.
