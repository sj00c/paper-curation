---
title: "2107_MOSAIC_Bridging_the_Sim-to-Real_Gap_in_Generalist_Humanoid_M"
authors:
  - "Zhenguo Sun"
  - "Bo-Sheng Huang"
  - "Yibo Peng"
...
arxiv: ""
score: 4.0
essence: "MOSAIC는 강화학습을 통해 학습한 범용 humanoid 동작 추적기와 빠른 residual 적응 메커니즘을 결합하여 시뮬레이션과 실제 로봇 간의 gap을 줄이고 장시간의 텔레오퍼레이션을 안정적으로 지원하는 시스템이다."
tags:
...
- 🔄 다른 접근: [[papers/2118_OmniClone_Engineering_a_Robust_All-Rounder_Whole-Body_Humano/review]] — 둘 다 sim-to-real gap 해결과 전신 텔레오퍼레이션을 다루지만, MOSAIC은 residual 적응에, OmniClone은 최적화된 정책 통합에 집중한다.
- 🏛 기반 연구: [[papers/1820_BeyondMimic_From_Motion_Tracking_to_Versatile_Humanoid_Contr/review]] — BeyondMimic의 모션 추적 기술이 MOSAIC의 범용 humanoid 동작 추적기 개발에 핵심적인 이론적 기반을 제공한다.
- 🔗 후속 연구: [[papers/2125_Opening_the_Sim-to-Real_Door_for_Humanoid_Pixel-to-Action_Po/review]] — Opening the Sim-to-Real Door의 순수 시각 기반 정책을 범용 동작 추적과 빠른 적응 메커니즘으로 확장한 연구이다.
- 🏛 기반 연구: [[papers/1640_ResMimic_From_General_Motion_Tracking_to_Humanoid_Whole-body/review]] — ResMimic의 residual learning 기법이 MOSAIC의 빠른 residual 적응 메커니즘 설계에 핵심 아이디어를 제공했다
- 🔗 후속 연구: [[papers/1673_Sim-and-Real_Co-Training_A_Simple_Recipe_for_Vision-Based_Ro/review]] — Sim-and-Real Co-Training의 sim-to-real 방법론이 MOSAIC의 simulation-reality gap 해결로 더욱 발전된 것이다
- 🔄 다른 접근: [[papers/1921_ExtremControl_Low-Latency_Humanoid_Teleoperation_with_Direct/review]] — 둘 다 humanoid teleoperation이지만 MOSAIC은 motion tracking에, ExtremControl은 low-latency control에 중점을 둔다
- 🏛 기반 연구: [[papers/2155_Towards_bridging_the_gap_Systematic_sim-to-real_transfer_for/review]] — 체계적인 sim-to-real 전이 연구가 MOSAIC의 시뮬레이션-실제 gap 해결을 위한 이론적 기반을 제공한다.
- 🔄 다른 접근: [[papers/1675_Sim-to-Real_of_Humanoid_Locomotion_Policies_via_Joint_Torque/review]] — Sim-to-real 전이에서 범용 동작 추적과 관절 토크 기반의 다른 접근법을 비교하여 각각의 장단점을 분석할 수 있다.
- 🔄 다른 접근: [[papers/1620_PolySim_Bridging_the_Sim-to-Real_Gap_for_Humanoid_Control_vi/review]] — MOSAIC은 단일 시뮬레이터에서 도메인 랜덤화를, PolySim은 여러 이질적 시뮬레이터를 사용하여 sim-to-real 간극을 다르게 해결함
- 🏛 기반 연구: [[papers/1942_GaussGym_An_open-source_real-to-sim_framework_for_learning_l/review]] — GaussGym의 고속 포토리얼리스틱 시뮬레이션이 MOSAIC의 sim-to-real 격차 해소를 위한 고품질 훈련 환경을 제공한다.
- 🧪 응용 사례: [[papers/1907_EmbodMocap_In-the-Wild_4D_Human-Scene_Reconstruction_for_Emb/review]] — EmbodMocap의 실외 인간 동작 데이터가 MOSAIC의 sim-to-real 격차 해소에 실제 환경 기반 검증 데이터로 활용될 수 있다.
- 🔄 다른 접근: [[papers/2118_OmniClone_Engineering_a_Robust_All-Rounder_Whole-Body_Humano/review]] — 둘 다 전신 휴머노이드 텔레오퍼레이션과 sim-to-real 문제를 다루지만, OmniClone은 진단 벤치마크 기반 최적화에, MOSAIC은 residual 적응에 집중한다.
- 🏛 기반 연구: [[papers/2125_Opening_the_Sim-to-Real_Door_for_Humanoid_Pixel-to-Action_Po/review]] — MOSAIC의 sim-to-real gap 해결을 위한 빠른 적응 메커니즘이 Opening the Sim-to-Real Door의 순수 RGB 기반 정책 전이에 방법론적 기반을 제공한다.
