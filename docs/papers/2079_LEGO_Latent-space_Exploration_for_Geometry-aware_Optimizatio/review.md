---
title: "2079_LEGO_Latent-space_Exploration_for_Geometry-aware_Optimizatio"
authors:
  - "Jihwan Yoon"
  - "Taemoon Jeong"
  - "Jeongeun Park"
...
arxiv: ""
score: 4.0
essence: "LEGO는 기존 로봇 설계 데이터와 인간 모션 데이터를 활용하여 humanoid 로봇의 kinematic 구조를 자동으로 최적화하는 데이터 기반 설계 프레임워크이다. Screw theory 기반 표현과 isometric manifold learning을 통해 compact한 latent space를 구성하고 gradient-free optimization으로 최적 설계를 탐색한다."
tags:
...
- 🏛 기반 연구: [[papers/1628_PyRoki_A_Modular_Toolkit_for_Robot_Kinematic_Optimization/review]] — 로봇 운동학적 최적화를 위한 모듈식 툴킷의 이론적 기반을 제공한다.
- 🔄 다른 접근: [[papers/1910_Embracing_Evolution_A_Call_for_Body-Control_Co-Design_in_Emb/review]] — 구현된 지능에서 몸체-제어 공동 설계의 다른 접근법을 제시한다.
- 🔗 후속 연구: [[papers/2150_Toward_Humanoid_Brain-Body_Co-design_Joint_Optimization_of_C/review]] — 휴머노이드 뇌-몸체 공동 설계의 공동 최적화 확장된 접근법을 보여준다.
- 🔗 후속 연구: [[papers/1916_Evolutionary_Continuous_Adaptive_RL-Powered_Co-Design_for_Hu/review]] — LEGO의 데이터 기반 설계 프레임워크를 진화적 최적화 방법론으로 확장하여 더 포괄적인 co-design을 달성할 수 있다.
- 🏛 기반 연구: [[papers/1648_RoboStriker_Hierarchical_Decision-Making_for_Autonomous_Huma/review]] — RoboStriker의 구조화된 잠재 공간 압축이 LEGO의 latent-space exploration for geometry-aware optimization 방법론을 권투 도메인에 적용한 것이다
- 🔗 후속 연구: [[papers/2133_PDF-HR_Pose_Distance_Fields_for_Humanoid_Robots/review]] — LEGO의 latent-space exploration이 PDF-HR의 pose manifold 표현을 geometry-aware optimization을 통해 확장한 형태입니다.
