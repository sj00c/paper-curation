---
title: "1927_Fauna_Sprout_A_lightweight_approachable_developer-ready_huma"
authors:
  - "Fauna Robotics"
  - ":"
  - "Diego Aldarondo"
...
arxiv: ""
score: 4.0
essence: "Sprout는 인간 환경에서의 안전한 배포, 표현성, 개발자 접근성을 강조하는 경량 휴머노이드 로봇 플랫폼이다. 낮은 물리적·기술적 진입장벽으로 구현된 통합 하드웨어-소프트웨어 스택을 제공한다."
tags:
...
- 🔄 다른 접근: [[papers/1796_AGILOped_Agile_Open-Source_Humanoid_Robot_for_Research/review]] — 둘 다 연구용 휴머노이드 플랫폼이지만 Sprout는 안전성과 접근성, AGILOped는 민첩성에 중점을 둔다.
- 🏛 기반 연구: [[papers/1715_ToddlerBot_Open-Source_ML-Compatible_Humanoid_Platform_for_L/review]] — ToddlerBot의 오픈소스 ML 호환 설계가 Sprout의 개발자 친화적 접근 방식의 기반이 된다.
- 🏛 기반 연구: [[papers/1630_Quasi-Direct_Drive_for_Low-Cost_Compliant_Robotic_Manipulati/review]] — Fauna Sprout의 경량 휴머노이드 플랫폼이 Quasi-Direct Drive 구동방식의 실제 적용 대상이 될 수 있다
- 🔗 후속 연구: [[papers/1796_AGILOped_Agile_Open-Source_Humanoid_Robot_for_Research/review]] — Fauna Sprout의 lightweight하고 접근하기 쉬운 개발자 친화적 특성이 AGILOped의 연구용 활용도를 확장시킬 수 있다
- 🔗 후속 연구: [[papers/1864_Demonstrating_Berkeley_Humanoid_Lite_An_Open-source_Accessib/review]] — Fauna Sprout의 접근하기 쉬운 개발자 친화적 특성이 Berkeley Humanoid Lite의 오픈소스 접근성을 더욱 향상시킬 수 있다
- 🧪 응용 사례: [[papers/1990_Human-Level_Actuation_for_Humanoids/review]] — Fauna Sprout의 경량 휴머노이드가 Human-Level Actuation Score 평가의 실제 적용 사례가 됩니다.
