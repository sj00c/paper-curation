---
title: "1928_Feature-Based_vs_GAN-Based_Learning_from_Demonstrations_When"
authors:
  - "Chenhao Li"
  - "Marco Hutter"
  - "Andreas Krause"
...
arxiv: ""
score: 4.0
essence: "Feature-based와 GAN-based 학습 방법론을 비교 분석하여, 각 접근법의 장단점을 명확히 하고 작업별 우선순위에 따른 방법 선택 프레임워크를 제시한다."
tags:
...
- 🧪 응용 사례: [[papers/1624_PRIMAL_Physically_Reactive_and_Interactive_Motor_Model_for_A/review]] — Feature-based vs GAN-based 비교 프레임워크가 물리적 반응형 모션 모델 선택에 적용될 수 있다.
- ⚖️ 반론/비판: [[papers/1801_AMP_Adversarial_Motion_Priors_for_Stylized_Physics-Based_Cha/review]] — GAN 기반 접근법과 적대적 모션 프라이어의 차이점을 명확히 하여 방법론 선택 기준을 제시한다.
- 🔄 다른 접근: [[papers/1252_ActiveUMI_Robotic_Manipulation_with_Active_Perception_from_R/review]] — 둘 다 demonstration 기반 학습을 다루지만 Feature-based vs. GAN-based는 방법론 비교에, ActiveUMI는 능동적 인식에 초점을 맞춘다.
- 🏛 기반 연구: [[papers/1817_Benchmarking_Potential_Based_Rewards_for_Learning_Humanoid_L/review]] — Feature-based vs GAN-based 비교 분석이 potential based rewards를 활용한 휴머노이드 학습의 방법론 선택 기준을 제공한다.
- 🔗 후속 연구: [[papers/1695_StyleLoco_Generative_Adversarial_Distillation_for_Natural_Hu/review]] — Feature-based와 GAN-based 학습 분석을 StyleLoco의 생성적 적대 증류에 적용하여 더 나은 자연스러운 휴머노이드 보행을 달성할 수 있다.
- 🧪 응용 사례: [[papers/2094_Mechanical_Intelligence-Aware_Curriculum_Reinforcement_Learn/review]] — Feature-based vs GAN-based 선택 프레임워크를 Mechanical Intelligence-Aware 커리큘럼 설계에 적용하여 최적의 학습 방법을 선택할 수 있다.
