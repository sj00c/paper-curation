---
title: "2129_ORCA_An_Open-Source_Reliable_Cost-Effective_Anthropomorphic"
authors:
  - "Clemens C. Christoph"
  - "Maximilian Eberlein"
  - "Filippos Katsimalis"
...
arxiv: ""
score: 4.0
essence: "ORCA는 2,000 CHF 미만의 재료비로 8시간 내에 조립 가능한 오픈소스 tendon-driven 인간형 로봇 손이며, popping joints와 자동 캘리브레이션 등의 설계로 높은 신뢰성과 정확도를 달성한다."
tags:
...
- 🔄 다른 접근: [[papers/1659_RUKA_Rethinking_the_Design_of_Humanoid_Hands_with_Learning/review]] — ORCA는 tendon-driven 저비용 설계, RUKA는 학습 기반 손 설계로 서로 다른 접근법의 휴머노이드 손 개발을 제시한다.
- 🔗 후속 연구: [[papers/1631_RAPID_Hand_A_Robust_Affordable_Perception-Integrated_Dextero/review]] — ORCA의 오픈소스 인간형 손을 RAPID Hand의 perception-integrated 기술과 결합하여 더 지능적인 저비용 로봇 손을 개발할 수 있다.
- 🏛 기반 연구: [[papers/2130_OSMO_Open-Source_Tactile_Glove_for_Human-to-Robot_Skill_Tran/review]] — ORCA의 신뢰성 있는 anthropomorphic 로봇 손이 OSMO의 tactile glove를 통한 인간-로봇 스킬 전이에 필요한 하드웨어 기반을 제공한다.
