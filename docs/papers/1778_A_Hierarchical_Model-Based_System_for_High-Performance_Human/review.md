---
title: "1778_A_Hierarchical_Model-Based_System_for_High-Performance_Human"
authors:
  - "Quanyou Wang"
  - "Mingzhang Zhu"
  - "Ruochen Hou"
...
arxiv: ""
score: 4.0
essence: "RoboCup 2024 우승팀의 완전히 통합된 성인용 휴머노이드 축구 로봇 시스템으로, QDD 액추에이터 기반 하드웨어와 계층적 perception-planning-control 아키텍처를 결합하여 동적이고 전술적으로 효과적인 게임플레이를 실현했다."
tags:
...
- 🔗 후속 연구: [[papers/1994_Humanoid_Goalkeeper_Learning_from_Position_Conditioned_Task-/review]] — 축구 로봇의 골키퍼 태스크는 완전한 축구 시스템의 특화된 구성 요소로 전체 시스템 성능을 향상시킬 수 있다
- 🔄 다른 접근: [[papers/2063_Learning_Soccer_Skills_for_Humanoid_Robots_A_Progressive_Per/review]] — 동일한 축구 도메인에서 progressive perception 기반 기술 학습과 계층적 시스템 설계라는 다른 접근법을 제시한다
- 🏛 기반 연구: [[papers/1674_Sim-to-Real_Learning_for_Humanoid_Box_Loco-Manipulation/review]] — 박스 조작을 통한 sim-to-real 학습 방법론이 축구 로봇의 실제 환경 적응에 필요한 기초 기술을 제공한다
- ⚖️ 반론/비판: [[papers/1715_ToddlerBot_Open-Source_ML-Compatible_Humanoid_Platform_for_L/review]] — 성인용 고성능 휴머노이드 축구 시스템과 미니어처 연구용 플랫폼 ToddlerBot의 설계 철학과 성능 차이를 보여줍니다.
- 🔗 후속 연구: [[papers/2046_Learning_Agile_Striker_Skills_for_Humanoid_Soccer_Robots_fro/review]] — 불완전한 인간 데이터에서 학습하는 스트라이커 기술을 완전 통합된 축구 시스템으로 확장한 연구입니다.
- 🔄 다른 접근: [[papers/1648_RoboStriker_Hierarchical_Decision-Making_for_Autonomous_Huma/review]] — 둘 다 휴머노이드 축구를 다루지만 하나는 완전 통합 시스템에, 다른 하나는 계층적 의사결정에 중점을 둔다.
- 🧪 응용 사례: [[papers/2003_Humanoid_Whole-Body_Badminton_via_Multi-Stage_Reinforcement/review]] — multi-stage 강화학습을 통한 배드민턴 기술이 축구 시스템의 복잡한 동적 움직임 계획에 적용될 수 있다.
- ⚖️ 반론/비판: [[papers/1715_ToddlerBot_Open-Source_ML-Compatible_Humanoid_Platform_for_L/review]] — ToddlerBot의 미니어처 설계와 달리 성인용 휴머노이드의 고성능 시스템 통합을 보여줍니다.
- 🏛 기반 연구: [[papers/1980_HiWET_Hierarchical_World-Frame_End-Effector_Tracking_for_Lon/review]] — hierarchical model-based system의 고성능 humanoid manipulation 방법론이 HiWET의 계층적 프레임워크 설계 기초를 제공한다.
- 🏛 기반 연구: [[papers/2001_Humanoid_Robot_Acrobatics_Utilizing_Complete_Articulated_Rig/review]] — Hierarchical model-based system이 complete articulated dynamics control의 기반이 됩니다.
