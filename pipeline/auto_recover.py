...
Usage:
  # 계획만 (변경 0)
  PYTHONUTF8=1 python pipeline/auto_recover.py --topic my-topic
  # 실제 복구 (audit→fix→re-review→re-audit 반복)
  PYTHONUTF8=1 python pipeline/auto_recover.py --topic my-topic --execute
  # LLM 판정 끄고 high 만 보수적으로
  PYTHONUTF8=1 python pipeline/auto_recover.py --topic my-topic --no-llm
"""
